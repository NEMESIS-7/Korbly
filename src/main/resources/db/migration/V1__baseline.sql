...
ALTER TABLE tranche
    ALTER COLUMN amount TYPE DECIMAL(0, 2) USING (amount::DECIMAL(0, 2));
...
ALTER TABLE tranche
    ALTER COLUMN interest_rate TYPE DECIMAL(0, 2) USING (interest_rate::DECIMAL(0, 2));
...
ALTER TABLE deal
    ALTER COLUMN total_amount TYPE DECIMAL(0, 2) USING (total_amount::DECIMAL(0, 2));